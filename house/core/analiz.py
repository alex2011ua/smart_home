...
from .models import DHT_MQ, Message, Params, Setting
...
def button_analiz(DEBUG):
    ...
    try:
        ...
        dor = Message.objects.create(
            controller_name="dor", date_message=datetime(2000, 1, 1), value_int=0
        )
        garaz = Message.objects.create(
            controller_name="garaz", date_message=datetime(2000, 1, 1), value_int=0
        )
